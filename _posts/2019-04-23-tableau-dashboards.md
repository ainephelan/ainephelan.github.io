...
# Bank Customer Segment Story
The following is a story deep-diving into the customer segmentation of an fictitious bank in the United Kingdom. The dataset can be downloaded from [here](https://sds-platform-private.s3-us-east-2.amazonaws.com/uploads/P1-UK-Bank-Customers.csv).
...
# Sales vs. Target by Department
This next dashboard is sales data for a fictitious supplier of office furniture, supplies and technology. The original data set can be downloaded [here](https://sds-platform-private.s3-us-east-2.amazonaws.com/uploads/P1-AmazingMartEU2.xlsx).

The dashboard compares actual sales across time with sales targets. You can filter on the different departments to see how sales have been tracking for each area. I've also included a visualisation of sales value above or below target, to give a very clear picture of sales performance for that month for the particular area.
