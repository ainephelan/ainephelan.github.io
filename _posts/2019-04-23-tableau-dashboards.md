...
Click through the below story for some initial, high-level insights. Each page is interactive, and each feature acts as a filter for all other features, allowing you to further explore at a more granular level. You can also select different bin values for age and bank balance.
